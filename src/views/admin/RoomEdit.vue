    ...
    <div class="selectBox">
      <el-form :model="priceStatusQuery" :inline="true">
        <el-form-item label="价格上限" >
            <el-input placeholder="请筛选价格上限"
                      v-model="priceStatusQuery.price"
                      >
                    </el-input>
        </el-form-item>
...
<el-table-column  label="房间状态" v-if="editOrNot" >
          ...
          <el-select size = "mini" v-model="scope.row.roomStatus" placeholder="请选择房间状态" 
            v-if="editOrNot">
              <el-option
        ...
        <el-table-column  label="房间图片链接" v-if="editOrNot">
          <template v-slot="scope">
            <el-input placeholder="请输入房间图片链接"
                      size="mini"
                      v-model="scope.row.ichnography"
                      ></el-input>
        ...
        <el-table-column align="center" fixed="right" label="操作" width="200">
          <template slot-scope="scope">
            ...
            <el-button @click="warn(scope.$index, tableData)" v-show="!editOrNot" type="primary" size="small">删除</el-button>
            <el-button @click="handleSave(scope.$index, tableData)" v-show="editOrNot" type="success" size="small">保存</el-button>
  ...
  :disabled="true">
    ...
    <el-form-item label="门店ID"  :label-width="formLabelWidth">
      <el-input v-model="form.HotelInstanceID"
  :disabled="true">
</el-input>
