...
<el-input v-model="formTable.roomId"
:disabled="true">
</el-input>
</el-form-item>

<el-form-item label="入住时间" >
          <el-date-picker v-model="formTable.ReserveCheckInTime" type="datetime" placeholder="请选择您的入住时间" format="yyyy-MM-dd HH:mm:ss"
            value-format="yyyy-MM-dd HH:mm:ss">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="退房时间" v >
          <el-date-picker v-model="formTable.ReserveCheckOutTime" type="datetime" placeholder="请选择您的退房时间" format="yyyy-MM-dd HH:mm:ss"
            value-format="yyyy-MM-dd HH:mm:ss">
          </el-date-picker>
        </el-form-item>

        <el-form-item label="平台编号" >
<el-input v-model="formTable.Platform"
:disabled="true">
</el-input>
</el-form-item>
...
<el-input v-model="formTable.roomAmount"
:disabled="true">
</el-input>
</el-form-item>
